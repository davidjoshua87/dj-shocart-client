  ...
  <div class="admin">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    <li><router-link to="/"><span class="glyphicon glyphicon-home"></span> Home</router-link></li>
                    <li><a @click="logout" style="cursor:pointer"><span class="glyphicon glyphicon-log-out"></span> Logout</a></li>
                </ul>
            </div>
        </div>
    </nav>
    <div class="container" style="margin-top:100px">
      <a data-toggle="modal" data-target="#addItem" style="cursor:pointer">
        <button class="btn btn-primary" style="margin-bottom:15px"><span class="glyphicon glyphicon-plus"> </span> Add Item</button>
      </a>
        ...
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                      <button @click="postimage()" type="submit" class="btn btn-default" style="width:100%;background-color:#3897f0;color:white;"><b>Add item</b></button>
                    </div>
                </div>
